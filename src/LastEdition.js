const LastEdition = () => {
  return (
    <div className="container text-light" id="assoc">
      ...
      <p>
        Malgré les conditions particulières de la Saint-Verhaegen 2020, la traditionnelle
        quête sociale s'est maintienu grâce aux dons en lignes. A cette occasion,
        les cercles de l'ACE et de l'ACS avaient récoltés <span className="text-warning">16181.09€ de dons en ligne </span>
         bénéficiant au <span className="text-warning"> Centre de Prévention des Violences
        Conjugales et Familiales</span>.
      </p>
      <div>
